                              ...
                              '<div class="card-body p-1 mt-0 align-middle">'+
                                ...
                                '<div class="d-flex justify-content-between align-items-center">'+
                                  '<div id="'+rating+'" class="ratings d-flex">'+
                                      ...
                                      '<span class="mb-0 px-0 py-0 my-0 align-text-bottom" style="font-size:11px !important;font-weight:400 !important;color:gray">'+ratingcount+'</span>'+
                                  '</div></div>'+
