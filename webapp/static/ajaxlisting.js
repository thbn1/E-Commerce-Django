                ...
                success: function (response) {
                    ...
                    for (var key in response) {
                        for (var i = 0; i < response[key].length; i++) {
                            ...
                            inhtml=   '<div class="col p-3">    <div class="card border border-1 shadow-sm p-1" id="prdcard" style="">' +
                            ...
                            '<div class="hover-overlay"><div class="mask" style="background-color: rgba(251, 251, 251, 0.15);"></div></div></a></div><div class="card-body mt-0 align-middle p-2" >'+
                            '<a href="/urunler/'+slug+'" class="text-reset" style="text-decoration: none;">'+
                            '<span id="cardname" class="card-title display-3 mx-0 px-0 mb-3" style="height:32px;" >'+pname+'</span></a><div class="d-flex justify-content-between align-items-center">'+
                            '<div id="'+rating+'" class="ratings">'+
                                    ...
                                    '<hr class="mb-3 mt-2">'+
                                    '<h1 class="mb-1" style="font-size:13px ; font-weight:600 !important;" id="cardprice">'+price+' TL</h1>'+
                                    '<button id="addbtn" type="button" class="btn w-100 mt-1" style="font-weight:400 !important;" data-mdb-ripple-color="dark">Sepete Ekle</button>'+
                                    '</div>'+
                                    '</div>'+
                                '</div></div>';
